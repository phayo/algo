...
public class BackspaceStringCompare {
    ...
    public static boolean backspaceCompare(String s, String t) {
        return performOperation(s).equalsIgnoreCase(performOperation(t));
    }
    ...
    private static String performOperationRedo(String input){
        char BACKSPACE = '#';
        char REDO = '@';
        ...
        for (char c : input.toCharArray()){
            if(BACKSPACE == c && !mainStack.isEmpty()){
                deleteStack.push(mainStack.pop());
            } else if(REDO == c && !deleteStack.isEmpty()){
                mainStack.push(deleteStack.pop());
            } else {
                mainStack.push(c);
            }
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(performOperationRedo("ab#@cabc##@bc"));
    }
}
